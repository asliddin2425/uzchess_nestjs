...
export class UserLessonsService {
  ...
  async getAll() {
    ...
    const userLessons = plainToInstance(UserLessonsListDto, rawUserLessons, {
  ...
  async getOne(id: number) {
    ...
    return plainToInstance(UserLessonsListDto, rawUserLessons, {
      excludeExtraneousValues: true,
    });
  }
  ...
  async create(payload: UserLessonsCreateDto) {
    ...
    return (
      plainToInstance(UserLessonsListDto, newUserLessons),
      {
        excludeExtraneousValues: true,
      }
    );
