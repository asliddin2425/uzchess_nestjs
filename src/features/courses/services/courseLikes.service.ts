...
export class CourseLikesService {
  ...
  async getAll() {
    ...
    const courseLikes = plainToInstance(CourseLikesListDto, rawCourseLikes, {
  ...
  async geTOne(id: number) {
    ...
    return plainToInstance(CourseLikesListDto, rawCourseLikes, {
      excludeExtraneousValues: true,
    });
  }
  ...
  async create(payload: CourseLikeCreateDto) {
    ...
    return (
      plainToInstance(CourseLikesListDto, newCourseLikes),
      {
        excludeExtraneousValues: true,
      }
    );
