...
export class PlayerService {
  ...
  async getAll() {
    ...
    const players = plainToInstance(PlayersListDto, rawPlayers, {
  ...
  async getOne(id: number) {
    ...
    return plainToInstance(PlayersListDto, rawPlayers, {
      excludeExtraneousValues: true,
    });
  }
  ...
  async create(payload: PlayersCreateDto) {
    ...
    return plainToInstance(PlayersListDto, newPlayers, {
      excludeExtraneousValues: true,
    });
  }
