...
export class BookCategoryService {
  ...
  async getAll() {
    ...
    const bookCategory = plainToInstance(BookCategoryListDto, rawBookCategory, {
  ...
  async getOne(id: number) {
    ...
    return plainToInstance(BookCategoryListDto, rawBookCategory, {
      excludeExtraneousValues: true,
    });
  }
  ...
  async create(payload: BookCategoryCreateDto) {
    ...
    return (
      plainToInstance(BookCategoryListDto, newBookCategory),
      {
        excludeExtraneousValues: true,
      }
    );
