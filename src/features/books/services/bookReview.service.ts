...
export class BookReviewService {
  ...
  async getAll() {
    ...
    const bookReview = plainToInstance(BookReviewListDto, rawBookReview, {
  ...
  async getOne(id: number) {
    ...
    return plainToInstance(BookReviewListDto, rawBookReview, {
      excludeExtraneousValues: true,
    });
  }
  ...
  async create(payload: BookReviewCreateDto) {
    ...
    return (
      plainToInstance(BookReviewListDto, newBookReview),
      {
        excludeExtraneousValues: true,
      }
    );
